...
public:
	 ...
	 * 非const引用作为输入，在蓝图中会解析为输出
	 * 所以要将非const参数作为输入，类型前加 UPARAM(ref)
	 */
	...
	UFUNCTION(BlueprintCallable, Category = "AuraAbilitySystemLibrary|DmageEffect")
