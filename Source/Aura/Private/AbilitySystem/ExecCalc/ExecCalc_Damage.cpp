                                              ...
                                              FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	for(const auto& Pair : FAuraGameplayTags::Get().DamageTypesToResistances)
	{
		...
		checkf(TagsToCaptureDefs.Contains(ResistanceTag), TEXT("TagsToCaputreDefs doesn't contain Tag: [%s] in ExecCalc_Damage"), *ResistanceTag.ToString());
		...
		if(UAuraAbilitySystemLibrary::IsRadialDamage(EffectContextHandle))
		{
			...
			//  	on the victim, which then broadcast OnDamageDelegate)
			...
			UGameplayStatics::ApplyRadialDamageWithFalloff(TargetAvatar, DamageTypeValue, 0.f, UAuraAbilitySystemLibrary::GetRadialDamageOrigin(EffectContextHandle),
				UAuraAbilitySystemLibrary::GetRadialDamageInnerRadius(EffectContextHandle), UAuraAbilitySystemLibrary::GetRadialDamageOuterRadius(EffectContextHandle),
