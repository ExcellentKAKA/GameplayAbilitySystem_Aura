...
UOverlayWidgetController* UAuraAbilitySystemLibrary::GetOverlayWidgetController(const UObject* WorldContextObject)
{
	...
	{
		return AuraHUD->GetOverlayController(WCParams);
	}
...
{
	UCharacterClassInfo* CharacterClassInfo = GetCharacterClassInfo(WorldContextObject);
	//在客户端上CharacterClassInfo是nullptr 直接返回
	...
	for(TSubclassOf<UGameplayAbility> AbilityClass : DefaultInfo.StartupAbilitiesAbilities)
	{
	...
	ECharacterClass CharacterClass, int32 CharacterLevel)
{
	...
	const FCharacterClassDefaultInfo Info = GetCharacterClassInfo(WorldContextObject)->GetClassDefaultInfo(CharacterClass);
...
bool UAuraAbilitySystemLibrary::IsNotFriend(AActor* FirstActor, AActor* SecondActor)
{
	...
	const bool bBothAreEnemies = FirstActor->ActorHasTag("Enemy") && SecondActor->ActorHasTag(FName("Enemy"));
